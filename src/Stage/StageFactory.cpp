...
namespace Stages {
  ...
  void StageFactory::loadTextures() {
    ...
    m_textureHolder.load(Textures::Player1Stagger, Textures::PLAYER1_STAGGER);
    ...
    m_textureHolder.load(Textures::Player2Stagger, Textures::PLAYER2_STAGGER);
  ...
  void StageFactory::createPlayers(int stageHeight) {
    m_players->include(new Entities::Player(m_textureHolder.getResource(Textures::Player1), m_textureHolder.getResource(Textures::Player1Walk1), m_textureHolder.getResource(Textures::Player1Walk2), m_textureHolder.getResource(Textures::Player1Walk3), m_textureHolder.getResource(Textures::Player1Jump), m_textureHolder.getResource(Textures::Player1Charge), m_textureHolder.getResource(Textures::Player1Stagger), m_soundHolder.getResource(Sounds::playerJump)));
    m_players->include(new Entities::Player(m_textureHolder.getResource(Textures::Player2), m_textureHolder.getResource(Textures::Player2Walk1), m_textureHolder.getResource(Textures::Player2Walk2), m_textureHolder.getResource(Textures::Player2Walk3), m_textureHolder.getResource(Textures::Player2Jump), m_textureHolder.getResource(Textures::Player2Charge), m_textureHolder.getResource(Textures::Player2Stagger), m_soundHolder.getResource(Sounds::playerJump), sf::Keyboard::Left, sf::Keyboard::Right, sf::Keyboard::Up));
